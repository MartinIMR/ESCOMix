...
main(void)
{
 unsigned char T[][200]=
	{ 
		...
		{0xff,0xff,0xff,0xff,0xff,0xff,0x12,0x12,0x12,0xaa,0xaa,0xaa,0x08,0x06,0x00,0x01,
		...
		{0x12,0x12,0x12,0xaa,0xaa,0xaa,0x22,0x22,0x22,0x22,0x22,0x22,0x08,0x06,0x00,0x01,
		...
		{0xff,0xff,0xff,0xff,0xff,0xff,0x12,0x12,0x12,0x12,0x12,0x12,0x08,0x06,0x00,0x01,
		...
		{0x12,0x12,0x12,0x12,0x12,0x12,0x12,0x12,0x12,0xaa,0xaa,0xaa,0x08,0x06,0x00,0x01,
...
analiza_ip(unsigned char T[])
{
   ...
   printf("Tamanio de la cabecera(IHL):%d bytes.\n",ihl);
   if( T[15] & 0x10 )
   {
