...
{	
   ...
   public static void inicializarMatrices(double [][] A,double [][] B)
   {
      	for(int i = 0; i < N; i++) 
		{
			for (int j = 0; j < N; j++)
  ...
  public static double[][] copia_matriz(double[][] A,int inicio)
	{
  ...
  public static void acomoda(double[][] C,double[][] A,int renglon,int columna)
  {
    for (int i = 0; i < N/2; i++)
      for (int j = 0; j < N/2; j++)
